package net.night.grasses.particle.custom;
...
public class LargeLeafParticle extends TextureSheetParticle {
    ...
    public LargeLeafParticle(ClientLevel pLevel, double pX, double pY, double pZ, SpriteSet spriteSet, Color colorRGB) {
        super(pLevel, pX, pY, pZ);
        this.setColor((float) colorRGB.getRed()/255, (float) colorRGB.getGreen() /255, (float) colorRGB.getBlue() /255);
