...
public class BlockEntitiesRegister {
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(Registries.BLOCK_ENTITY_TYPE, Grasses.MOD_ID);


    public static Supplier<BlockEntityType<DyeingStationBlockEntity>> DYEING_STATION_BE =
    ...
    public static Supplier<BlockEntityType<TintedBlockEntity>> TINTED_BE =
            BLOCK_ENTITIES.register("tinted_be", () ->
                    BlockEntityType.Builder.of(TintedBlockEntity::new,
                            ...
                            GRASS_SHORT_TINTED.get(), GRASS_TALL_TINTED.get(), FERN_TINTED.get(), FERN_TALL_TINTED.get(), SEAGRASS_TINTED.get(), SEAGRASS_TALL_TINTED.get(), VINE_TINTED.get(), LILY_TINTED.get(), SUGAR_CANE_TINTED.get(), BAMBOO_TINTED.get(), BAMBOO_SAPLING_TINTED.get(), BIG_DRIP_LEAF_TINTED.get(), BIG_DRIP_LEAF_STEM_TINTED.get(), SMALL_DRIP_LEAF_TINTED.get(), KELP_TINTED.get(), KELP_PLANT_TINTED.get(), CACTUS_TINTED.get(), GRASS_IN_BARS.get(), FERN_IN_BARS.get(), VINE_IN_BARS.get(), TINTED_GRASS_IN_BARS.get(), TINTED_FERN_IN_BARS.get(), TINTED_VINE_IN_BARS.get(),
